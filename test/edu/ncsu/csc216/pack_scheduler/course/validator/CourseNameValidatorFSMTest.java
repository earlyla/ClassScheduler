...
class CourseNameValidatorFSMTest {
	...
	CourseNameValidatorFSM courseNameValidator;
	...
	@BeforeEach
	void setUp() {
		courseNameValidator = new CourseNameValidatorFSM();
	}
	 ...
	 */
	@Test
	void testIsValid3letter3digit1suffix() {
		try {
	 ...
	 */
	@Test
	void testIsValid4letter3digit1suffix() {
		try {
	...
	void testIsValidBadCourseNamePunctuation() {
		...
		assertEquals(e1.getMessage(), "Course name can only contain letters and digits.");
	}
	...
	void testIsValidBadCourseNameLLLLDDDSD() {
		...
		assertEquals(e1.getMessage(), "Course name cannot contain digits after the suffix.");
	}
