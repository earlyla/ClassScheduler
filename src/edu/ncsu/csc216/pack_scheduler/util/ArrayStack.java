...
/**
 * Custom stack interface (as an ArrayList) which allows a user to push (add an element to top of stack), pop (remove an element
...
public class ArrayStack<E> implements Stack<E> {
	...
	/**
	 * Creates a new stack with the specified capacity. Initialized an 
	 * empty ArrayList with size of 0.
	 *  
